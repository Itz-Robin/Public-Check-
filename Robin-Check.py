...
#==============================================================================================
	...
	print("\033[92;1m Developer  By - Md. Shajahan Kabir") 
...
def menu():
    ...
    print("\033[93;1m     ASSALAMUYALKUM : \033[92;1m"+xn)
...
def crack_select1():
	...
	print("\033[94;1m  Aktu Opekha Korun\033[92;1m✘\033[91;1m✘\x1b[0m")
...
def crack():
	...
	print("\033[93;1m  [2] CRACK FOLLOWERS ID")
	...
	if select =="1":
		...
		for t in range(id_limit):
			...
			try:
				...
				print("\033[91;1m  PRIVATE FRIEND LIST BRO TRY ANOTHER PUBLIC ID")
		...
		for t in range(id_limit):
			...
			try:
				...
				print("\033[91;1m  PRIVATE FRIEND LIST BRO TRY ANOTHER ONE")
